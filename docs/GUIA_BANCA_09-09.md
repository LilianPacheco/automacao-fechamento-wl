...
7. Na revisão integrada, mostre os filtros **Pendente** e **Confirmado** e abra uma foto original.
8. Edite um campo pendente e mostre que a entrada continua pendente até a situação ser alterada.
9. Use **Aprovar todos os confirmados** e depois **Consolidar aprovados**.
10. Importe somente na cópia de demonstração e mostre a mensagem com as linhas e o backup.
